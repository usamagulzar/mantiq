...
if (copyAlgBtn) {
    copyAlgBtn.addEventListener('click', () => {
        ...
        if (body && body.dataset.rawProof) {
            ...
            navigator.clipboard.writeText(body.dataset.rawProof + watermark).then(() => {
...
if (exportKmapPngBtn) {
    exportKmapPngBtn.addEventListener('click', () => {
        ...
        html2canvas(kmapVisualWrapper, {
            ...
            ctx.textAlign = 'right';
            ctx.fillText('Generated by Mantiq (https://usamagulzar.github.io/mantiq)', finalCanvas.width - 15, finalCanvas.height - 15);
