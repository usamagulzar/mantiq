...
function initExportButtons() {
        ...
        exportCsvBtn.addEventListener('click', () => {
            ...
            if (jsonStr) {
                try {
                    ...
                    csvContent += "\r\nGenerated by Mantiq (https://" + (window.url || "mantiq.usamagulzar.com") + ")\r\n";
        ...
        exportWaveBtn.addEventListener('click', () => {
            ...
            if (canvas) {
                try {
                    ...
                    tempCanvas.height = canvas.height + 30; // 30px padding at bottom for watermark
                    ...
                    ctx.textAlign = 'right';
                    ctx.fillText('Generated by Mantiq (https://' + (window.url || 'mantiq.usamagulzar.com') + ')', tempCanvas.width - 10, tempCanvas.height - 10);
    ...
    if (copyGateBtn) {
        copyGateBtn.addEventListener('click', () => {
            ...
            if (code) {
                const watermark = '\n\n// Generated by Mantiq (https://' + (window.url || 'mantiq.usamagulzar.com') + ')';
                navigator.clipboard.writeText(code + watermark).then(() => {
    ...
    if (saveGateBtn) {
        saveGateBtn.addEventListener('click', () => {
            ...
            if (code) {
                const watermark = '\n\n// Generated by Mantiq (https://' + (window.url || 'mantiq.usamagulzar.com') + ')';
                saveCodeToFile(code + watermark, 'gate_level');
            }
        });
    }
    ...
    if (saveDataflowBtn) {
        saveDataflowBtn.addEventListener('click', () => {
            ...
            if (code) {
                const watermark = '\n\n// Generated by Mantiq (https://' + (window.url || 'mantiq.usamagulzar.com') + ')';
                saveCodeToFile(code + watermark, 'dataflow');
            }
        });
    }
